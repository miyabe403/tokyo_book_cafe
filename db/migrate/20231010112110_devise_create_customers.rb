...
class DeviseCreateCustomers < ActiveRecord::Migration[6.1]
  def change
    create_table :customers do |t|
      ...
      t.string :last_name, null: false                    # 名前・姓     (会員)
      t.string :first_name, null: false                   # 名前・名     (会員)
      t.string :last_name_kana, null: false               # 名前・カナ姓 (会員)
      t.string :first_name_kana, null: false              # 名前・カナ名 (会員)
